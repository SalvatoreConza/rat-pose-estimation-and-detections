...
top_labels = {
    ...
    12: 'front_left_elbow',
    13: 'front_left_paw',
    14: 'front_left_shoulder',
    15: 'front_left_wrist',
    16: 'front_right_elbow',
    17: 'front_right_paw',
    18: 'front_right_shoulder',
    19: 'front_right_wrist',
    20: 'head_midpoint',
    21: 'left_ear_base',
    22: 'left_ear_tip',
    23: 'left_eye',
    ...
    29: 'tail_base',
    30: 'tail_end',
    31: 'tail_lower_midpoint',
    32: 'tail_midpoint',
    33: 'tail_upper_midpoint',
    34: 'throat'
}
...
if __name__ == '__main__':
    image_test_folder  = r'C:\Users\Lund University\Documents\GitHub\bnl-ai\950bottom_corrected\test'
    annotation_path    = r'C:\Users\Lund University\Documents\GitHub\bnl-ai\950bottom_corrected\annotations.csv'
    ...
    with open(r'C:\Users\Lund University\Documents\GitHub\bnl-ai\config\hrnet_w48_384_288.yaml', 'r') as f: yaml_text = f.read()
    cfg_w48_384_288 = yaml.load(yaml_text, Loader=yaml.SafeLoader)
    cfg_w48_384_288['MODEL']['NUM_JOINTS'] = 35
    model = hrnet.get_pose_net(cfg_w48_384_288, is_train=False)
    model = model.to(device)
    model.load_state_dict(torch.load(r"C:\Users\Lund University\Documents\GitHub\bnl-ai\out\train_pose-250626_034557\snapshot_PoseHRNet-W48_288x384.pth", weights_only=True, map_location=device))
